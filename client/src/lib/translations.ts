export const translations = {
  en: {
    ...
    home: {
      ...
      experience5YearsDesc: "Five years of perfecting our craft, building relationships with customers, and preserving Portuguese culinary traditions.",
  ...
  pt: {
    ...
    home: {
      ...
      experience5YearsDesc: "Cinco anos a aperfeiçoar a nossa arte, construir relacionamentos com clientes e preservar tradições culinárias portuguesas.",
